...
public class HexaSystemPositionsCheckIfCorrect {
    ...
    private boolean checkNorthNeighbors(HexaSystem system) {
        ...
        for (HexaSystem e : system.getNeighbors()) {
            ...
            if (e.getCardinal().equals("NorthEast") || e.getCardinal().equals("NorthWest") || e.getCardinal().equals("Center")) {
                amountOfNeighbors++;
            }
        }
    ...
    private boolean checkNorthEastNeighbors(HexaSystem system) {
        ...
        for (HexaSystem e : system.getNeighbors()) {
            ...
            if (e.getCardinal().equals("North") || e.getCardinal().equals("SouthEast") || e.getCardinal().equals("Center")) {
                amountOfNeighbors++;
            }
        }
    ...
    private boolean checkNorthWestNeighbors(HexaSystem system) {
        ...
        for (HexaSystem e : system.getNeighbors()) {
            ...
            if (e.getCardinal().equals("North") || e.getCardinal().equals("SouthWest") || e.getCardinal().equals("Center")) {
                amountOfNeighbors++;
            }
        }
    ...
    private boolean checkSouthNeighbors(HexaSystem system) {
        ...
        for (HexaSystem e : system.getNeighbors()) {
            ...
            if (e.getCardinal().equals("SouthEast") || e.getCardinal().equals("SouthWest") || e.getCardinal().equals("Center")) {
                amountOfNeighbors++;
            }
        }
    ...
    private boolean checkSouthEastNeighbors(HexaSystem system) {
        ...
        for (HexaSystem e : system.getNeighbors()) {
            ...
            if (e.getCardinal().equals("South") || e.getCardinal().equals("NorthEast") || e.getCardinal().equals("Center")) {
                amountOfNeighbors++;
            }
        }
    ...
    private boolean checkSouthWestNeighbors(HexaSystem system) {
        ...
        for (HexaSystem e : system.getNeighbors()) {
            ...
            if (e.getCardinal().equals("South") || e.getCardinal().equals("NorthWest") || e.getCardinal().equals("Center")) {
                amountOfNeighbors++;
            }
        }
